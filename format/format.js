					...
					commands: {
						insertMove(editor) {
							...
							if( editor.getDoc().somethingSelected()) {
								...
								editor.replaceRange('[move route]', { line: editor.getCursor().line, ch: '[move route]'.length - 1 });
							}
						},
						insertLoad(editor) {
							editor.focus();
							...
							if( editor.getDoc().somethingSelected()) {
								...
								editor.replaceRange('[move route]', editor.getCursor().line, '[move route]'.length - 1);
							}
						},
